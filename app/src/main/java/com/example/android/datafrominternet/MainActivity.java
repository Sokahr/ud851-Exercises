...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithub$SearchQuery() {
        String gitHubString = mSearchBoxEditText.getText().toString();
        URL url = NetworkUtils.buildUrl(gitHubString);
