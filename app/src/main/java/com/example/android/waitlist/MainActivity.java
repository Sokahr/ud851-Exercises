...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if (mNewPartySizeEditText.getText() == null || mNewPartySizeEditText.getText().toString().trim().length() == 0) {
            return;
        }
        if(mNewGuestNameEditText.getText() == null || mNewGuestNameEditText.getText().toString().trim().length() == 0) {
            return;
        }
