...
public class NotificationUtils {
    ...
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "com.example.android.water_reminder";
    private static final int WATER_REMINDER_NOTIFICATION_ID = 1371;
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, WATER_REMINDER_PENDING_INTENT_ID, startActivityIntent, PendingIntent
                .FLAG_UPDATE_CURRENT);
