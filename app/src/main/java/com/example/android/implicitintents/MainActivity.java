...
public class MainActivity extends AppCompatActivity {
    ...
    private void shareText(String text) {
        ...
        String chooserTitle = "Which Community will you tell Hello?";
        // DONE (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
        Intent shareIntent = ShareCompat.IntentBuilder.from(this).setChooserTitle(chooserTitle).setType
                (mimeType).setText(text).createChooserIntent();
