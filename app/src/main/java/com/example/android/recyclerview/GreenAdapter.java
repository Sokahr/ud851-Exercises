...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        int viewHolderBackgroundColorFromInstance = ColorUtils.getViewHolderBackgroundColorFromInstance(context,
                viewHolderCount);
        ...
        viewHolderCount++;
        Log.i(TAG, "onCreateViewHolder: viewHolderCount = "+viewHolderCount);
        return viewHolder;
    }
