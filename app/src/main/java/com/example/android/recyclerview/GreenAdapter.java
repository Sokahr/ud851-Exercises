...
public interface ListItemClickListener {
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public NumberViewHolder(View itemView) {
            ...
            // DONE (7) Call setOnClickListener on the View passed into the constructor (use 'this' as the
            // OnClickListener)
        ...
        // DONE (6) Override onClick, passing the clicked item's position (getAdapterPosition()) to mOnClickListener via
        // its onListItemClick method
        /**
