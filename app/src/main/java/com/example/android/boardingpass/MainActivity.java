...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long hours = TimeUnit.MINUTES.toHours(minutesUntilBoarding);
        long minutes = minutesUntilBoarding - TimeUnit.MINUTES.toMinutes(hours);
        mBinding.textViewBoardingInCountdown.setText(getString(R.string.countDownFormat, hours, minutes));
